...
<div id="header-carousel" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active">
      <img class='header-img' src="${pageContext.request.contextPath}/img/header.jpg" alt="header">
      <div class="carousel-caption"></div>
    </div>
    <div class="item">
      <img class='header-img' src="${pageContext.request.contextPath}/img/header2.jpg" alt="header">
    ...
    <span class="sr-only">Next</span>
  	...
  	<div class="container" id="main-container">
		<div class="section section-forum">
			...
			<hr>
			<div class="row">
			  <div class="col-sm-6 col-md-4 card-box">
			    <div class="thumbnail">
